    ...
    <x-slot name="content">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ms-3">
                            <div class="text-sm text-gray-600 dark:text-gray-400">
                                {{ $session->agent->platform() ? $session->agent->platform() : __('Desconocida') }} - {{ $session->agent->browser() ? $session->agent->browser() : __('Desconocida') }}
                            </div>
        ...
        <div class="flex items-center mt-5">
            <x-button wire:click="confirmLogout" wire:loading.attr="disabled">
                {{ __('Cerrar sesion en otras sesiones de navegador') }}
            </x-button>
