            ...
            <div>
                ...
                <ul class="mt-3">
                    ...
                    <li
                        ...
                        <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-[linear-gradient(135deg,var(--tw-gradient-stops))] @if (Request::segment(1) === 'impresiones') from-violet-100/[0.12] dark:from-violet-100/[0.24] to-violet-100/[0.04] @endif">
    <a class="block text-gray-100 dark:text-gray-100 truncate transition @if (Request::segment(1) !== 'impresiones') hover:text-orange-400 dark:hover:text-orange-400 @endif"
        href="{{ route('impresiones.index') }}">
        <div class="flex items-center">
            <svg class="shrink-0 fill-current @if (Request::segment(1) === 'impresiones') text-orange-400 @else text-gray-200 dark:text-gray-200 @endif"
                xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 22 22">
                <path fill="currentColor"
                    d="M4 19v2c0 .5523.44772 1 1 1h14c.5523 0 1-.4477 1-1v-2H4Z" />
                <path fill="currentColor" fill-rule="evenodd"
                    d="M9 3c0-.55228.44772-1 1-1h8c.5523 0 1 .44772 1 1v3c0 .55228-.4477 1-1 1h-2v1h2c.5096 0 .9376.38314.9939.88957L19.8951 17H4.10498l.90116-8.11043C5.06241 8.38314 5.49047 8 6.00002 8H12V7h-2c-.55228 0-1-.44772-1-1V3Zm1.01 8H8.00002v2.01H10.01V11Zm.99 0h2.01v2.01H11V11Zm5.01 0H14v2.01h2.01V11Zm-8.00998 3H10.01v2.01H8.00002V14ZM13.01 14H11v2.01h2.01V14Zm.99 0h2.01v2.01H14V14ZM11 4h6v1h-6V4Z"
