<div class="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700">
    <div class="px-5 pt-5">
        <header class="flex justify-between items-start mb-2">
            ...
            <div class="relative inline-flex" x-data="{ open: false }">
                ...
                >
                    <ul>
                        <li>
                            <a class="font-medium text-sm text-slate-600 dark:text-slate-300 hover:text-slate-800 dark:hover:text-slate-200 flex py-1 px-3" href="#0" @click="open = false" @focus="open = true" @focusout="open = false">U.FICCT</a>
                        </li>
        ...
        <h2 class="text-lg font-semibold text-slate-800 dark:text-slate-100 mb-2">Ganancias</h2>
        <div class="text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase mb-1">Dinero</div>
        <div class="flex items-start">
            <div class="text-2xl font-bold text-slate-800 dark:text-slate-100 mr-2 mb-4">Bs. {{ number_format($ganancias, 2) }}</div>
        </div>
    </div>
