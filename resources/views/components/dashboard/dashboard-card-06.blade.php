<div class="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700">
    <div class="px-5 pt-5">
        ...
        <h2 class="text-lg font-semibold text-slate-800 dark:text-slate-100 mb-2">Usuarios</h2>
        <div class="text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase mb-1">Cantidad</div>
        <div class="flex items-start">
            <div class="text-2xl font-bold text-slate-800 dark:text-slate-100 mr-2 mb-4">Urs. {{ $usuario }}</div>
        </div>
    </div>
