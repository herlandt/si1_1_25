                ...
                <div class="flex flex-col sm:flex-row items-center w-full justify-between">
                    ...
                    <div class="flex flex-1 items-center mb-2 sm:mb-0 space-x-2">
                        <a id="modal-toggle-button"
                            class="flex-shrink-0 bg-cyan-800 hover:bg-cyan-600 dark:bg-slate-700 dark:hover:bg-slate-600 text-white dark:text-gray-200 font-semibold px-1.5 py-1 rounded-md text-xs sm:text-xs ml-1 mr-1">
                        ...
                        @hasanyrole('ejecutivo|general')
                            <a href="{{ route('compras.export', ['start_date' => request('start_date'), 'end_date' => request('end_date')]) }}"
                    ...
                    <div class="flex flex-col sm:flex-row items-center space-x-2">
                        ...
                        <form method="GET" action="{{ route('compras.index') }}" class="flex items-center space-x-2">
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center">
                                ...
                                <button type="submit"
                                    class="bg-cyan-900 hover:bg-cyan-700 text-white dark:bg-gray-700 dark:hover:bg-gray-600 text-white font-bold py-1 px-3 rounded-md text-xs">
                                    Aceptar
                                </button>
                            </div>
                        </form>
            ...
            <div class="p-3">
                ...
                <div class="overflow-x-auto">
                    <table class="table-auto w-full">
                        <h1 class="text-xs text-center font-semibold text-slate-500 dark:text-slate-300 mb-2">COMPRAS
                        </h1>
                        <!-- Table header -->
                        <thead
                            ...
                            <tr>
                                ...
                                <th class="p-2 whitespace-nowrap">
                                    <div class="font-semibold text-center">Precio C.</div>
                                </th>
                                <th class="p-2 whitespace-nowrap">
                                ...
                                <th class="p-2 whitespace-nowrap">
                                    <div class="font-semibold text-center">Precio v.</div>
                                </th>
                                <th class="p-2 whitespace-nowrap">
                                    <div class="font-semibold text-center">Metodo</div>
                                </th>
                                <th class="p-2 whitespace-nowrap">
                                    <div class="font-semibold text-center">Producto Cod.</div>
                                </th>

                                <th class="p-2 whitespace-nowrap">
                                    <div class="font-semibold text-center">Proveedor</div>
                                </th>
                                <th class="p-2 whitespace-nowrap">
                        ...
                        <tbody id="searchTableBody" class="text-xs divide-y divide-slate-100 dark:divide-slate-700">
                            ...
                            @foreach ($compras as $c)
                                <tr>
                                    ...
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="text-left font-medium">{{ $c->nombre }}</div>
                                    </td>
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="text-center font-medium">{{ $c->preciocompra }}</div>
                                    </td>
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="text-left font-medium">{{ $c->cantidad }}</div>
                                    </td>

                                    <td class="p-2 whitespace-nowrap">
                                        <div class="text-center font-medium">{{ $c->total }}</div>
                                    </td>
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="text-center font-medium">{{ $c->precioventa }}</div>
                                    </td>
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="text-center font-medium">{{ $c->metodo }}</div>
                                    </td>
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="text-center font-medium">{{ $c->producto->codigo }}</div>
                                    </td>

                                    <td class="p-2 whitespace-nowrap">
                                        <div class="text-center font-medium">{{ $c->proveedor }}</div>
                                    </td>
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="text-center font-medium">{{ $c->user_id }}</div>
                                    </td>
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="text-center font-medium">{{ $c->estado }}</div>
                                    </td>
                                    <td class="p-2 whitespace-nowrap">
                                    ...
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="text-center font-medium flex space-x-2">
                                            <!-- Botón de editar -->
                                            <a title="Ver" href="{{ route('compras.edit', $c->id) }}"
    ...
    <div id="crud-modal4" tabindex="-1" aria-hidden="true"
        ...
        <div class="flex items-center justify-center h-full">
            <div class="relative p-4 w-full max-w-lg bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <!-- Modal body -->
                <div class="mt-2">
                    <form method="POST" action="{{ route('compras.import') }}" enctype="multipart/form-data"
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <form action="{{ route('compras.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="p-4 md:p-5">
                        ...
                        <div class="mb-4">
                            <label for="nombre"
                                class="block text-sm font-medium text-gray-700 dark:text-gray-300">Codigo</label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" name="preciocompra" id="preciocompra" step="0.01"
                                    class="p-2 block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-white rounded-md"
                                    placeholder="Introduzca el precio de compra">
                            </div>
                            <div>
